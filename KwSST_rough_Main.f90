...
!********************************************************************************************* 
 Intent(In   )::Dim,Ncyc,INW,X,Y,NX,NY,NC,NF,NF1,NF2,NFW1,NFW2,NFI1,NFI2,NFO1,NFO2,NFS1,NFS2,&
                NFF1,NFF2,NP,IDS,XC,YC,DW,DT,A,MR,NRKS,RKJ,Mu0,WB,WNP1,Mu,DUY
 ...
 Real(8),Dimension(1:Dim)::DUX_C,DUY_C,DVX_C,DVY_C,DKX_C,DKY_C,DOmegX_C,DOmegY_C,DKX_F,DKY_F,&
                           DOmegX_F,DOmegY_F,F11,F22,Sigk,Sigw,Beta,Gama,X,Y,NX,NY,A,Mu,Mut,XC,YC,DW,DT,DUY
...
!Part 3:
 Do NS=1,NRKS
   ...
   !Part 5:
    ...
    Call Kw_BC_rough(Dim,NF,NFS1,NFS2,NFO1,NFO2,NFW1,NFW2,NFI1,NFI2,NFF1,NFF2,IDS,MR,NX,NY,&
