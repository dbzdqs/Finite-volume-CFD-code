...
!//----------------------------------------------------------------------------------------------------//!
!// Description:                                                                                       //!
!// This Code designed for solving steady and Inviscid form of two dimensional Navier-Stocks equations //!
!// that known as Euler equations. One of the overt advantage of this code is that it enjoy several    //!
!// subroutines that assists user to follow code step by step. Mesh and Settings have external files   //!
!// that read through their subroutines in the first step of code. Discretization of convective terms  //!
!// is done by preconditioning  form of Roe approximate Riemann solver .In addition explicit scheme    //!
!// used for time marching  Main features of this code is as following:                                //!                                                         //!
!// 1-Dimension:	                            2D                                                     //!
...
!// 7-Convection Discretization Scheme:	        Roe with Turkle Precondition                           //!
...
!////////////////////////////////////////////////////////////////////////////////////////////////////////!
!*********************************************************************************************************
 Program DANS_InviscidRoePrecondition2D
 Implicit None
...
!Part 9:
 ...
 Call BC_Riemann_RoePreCond(Dim,NFF1,NFF2,NX,NY,DA,IDS,GM,U0,V0,P0,R0,C0,WNP1,P,WB)
...
!Part 11:
 Do While(Rm > ERmx)
   ...
   !Part 14:
	Call TimSTP_Inviscid_RoePreCond(Dim,NC,NF1,NF2,NF,IDS,NX,NY,A,DA,CFLx,GM,P,WNP1,WB,Minf,DT)
   ...
   !Part 15:
    Do NS=1,NRKS
      ...
      !Part 17:
	   Call ConMeanFlow_RoePreCond(Dim,NC,NF1,NF2,NF,IDS,NX,NY,DA,GM,WNP1,WB,P,Minf,Con)
