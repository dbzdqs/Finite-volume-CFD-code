...
!// gradients. Also code use wide range of algebraic turbulent models, ranging from Prandtle_Escuider  //!
!// to Thomas for calculating turbulence viscosity.  Main features of this code is as following:       //!
!// 1-Dimension:	                            2D                                                     //!
...
!// 12-Turbulence Model:	                    Prandtle_Escudier                                      //!
!//                                             Baldwin_Lomax                                          //!
!//                                             Cebeci_Smith                                           //!
!//                                             Thomas                                                 //!
...
!////////////////////////////////////////////////////////////////////////////////////////////////////////!
!*********************************************************************************************************
 Program DANS_AlgebraicTurbModel2D
 Implicit None
!===============================
...
!===============================
 ...
 Integer,Allocatable,Dimension(:,:)::INEARSTCELL !Index of Nearst cell to wall
 Integer,Allocatable,Dimension(:)::NNEARSTCELL !Number of Cells in a Profile
...
!For Baldwin_Lomax and Cebeci_Smith Turb model
 !!!Allocate( INearstCell(NFW1:NFW2,1:12000) )
 !!!Allocate( NNearstCell(NFW1:NFW2) )
 !!!Call NearstCellProfile(Dim,NC,NFW1,NFW2,DW,INW,NNearstCell,INearstCell)
...
!Part 13:
 Call EddyVisInit(Dim,NC,Mu0,Mut0,Mut)
...
!Part 15:
 Do While(Rm > ERmx)
   ...
   !Part 19:
    ...
    !Part 29:
     !!!Call Prandtl_Escudier(Dim,NC,NF1,NF2,NF,IDS,NX,NY,Xc,A,INW,DW,MR,Rinf,Mut0,WB,WNP1,Mu,Mut,DUY,R0,U0,Mu0)
     !!!Call Baldwin_Lomax(Dim,NC,NF1,NF2,NF,NFW1,NFW2,IDS,NX,NY,A,INW,DW,NNearstCell,INearstCell,MR,Mut0,WB,WNP1,Mu,Mut)
     !!!Call Cebeci_Smith(Dim,NC,NF1,NF2,NF,IDS,NX,NY,Xc,A,MR,NFW1,NFW2,DW,INW,Rinf,P,WB,WNP1,Mu,NNearstCell,INearstCell,Mut)
     Call Thomas(Dim,NC,NF,NF1,NF2,NFW1,NFW2,IDS,NX,NY,A,INW,Mut0,Rinf,MR,Mu,WB,WNP1,Mut)
