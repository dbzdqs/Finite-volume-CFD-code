...
!//----------------------------------------------------------------------------------------------------//!
!// Description:                                                                                       //!
!// This Code designed for solving steady and inviscid form of two dimensional Euler equations. One of //!
!// the main advantages of this code is that it enjoy several subroutines that assists user to follow  //!
!// code step by step. Mesh and Settings have external files that read through their subroutines in the//!
!// first step of code. In addition code possess wide range methods of convergence acceleration range  //!
!// from Enthalpy damping to residual smoothing. furthermore code is equipped by fourth order          //!
!// Runge-kutta method for reaching conservative variables. Main features of this code is              //!
!// as following:                                                                                      //!
!// 1-Dimension:	                            2D                                                     //!
...
!// 10-Steady/Unsteady: 	                    Steady                                                 //!
!// 11-Convergence acceleration methods: 	    Local time stepping                                    //!
!//                                             Explicit Residual Smoothing                            //!
!//                                             Implicit Residual Smoothing                            //!
!//                                             Enthalpy Damping                                       //!
!// 12-Gradient Calculation Scheme:	            non                                                    //!
!// 13-Turbulence Model:	                    non                                                    //!
!// 14-Moving Mesh Method:	                    non                                                    //!
!////////////////////////////////////////////////////////////////////////////////////////////////////////!
!*********************************************************************************************************
 Program DANS_Inviscid_ConvergenceAcceleration
 Implicit None
!===============================
...
!===============================
 ...
 Integer,Dimension(1:Dim)::IA,JA  !!The Row and Column Indices of the Matrix Values
 Integer::cnt
 Integer::itr_max !!Maximum iteration
 Integer::itr_in  !!Inner loop iteration
 Real(8)::Tol_abs !!Absolute Tolerance 
 Real(8)::Tol_rel !!Real Tolerance 
 Real(8),Dimension(1:Dim)::AA  !!  Local Variable for Area of each cell
!************************************************** Main **************************************************
!Part 1:
...
!Part 11:
 call ResidualCoefficient(Dim,NC,NF1,NF2,IDS,EPS,ia,ja,AA,cnt)
   ...
   !Part 16:
    Do NS=1,NRKS
      ...
      !Part 18:
       ...
       !Part 19:
       !Eps=0.2
	   !CALL ResidualSmoothing_expilicit(Dim,NC,NF1,NF2,IDS,Eps,Con)  
       !itr_max = 10
       !itr_in  = 50
       !tol_abs = 0.001
       !tol_rel = 0.001
       !Call GMRES_ST(Dim,NC,cnt,ia,ja,aa,Con,Con,itr_max,itr_in,tol_abs,tol_rel)
       !Call Enthalpy_Damp(Dim,NC,GM,DT,H0,Wnp1)
