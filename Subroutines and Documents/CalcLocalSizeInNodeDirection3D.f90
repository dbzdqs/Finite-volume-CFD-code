...
!////////////////////////////////////////////////////////////////////////////////////////////!
!*********************************************************************************************
 Subroutine CalcLocalSizeInNodeDirection3D(Dim,NP,X,Y,Z,NodeMetric,Node1,Node2,h)
 Implicit None
!*********************************************************************************************
 Integer::Dim,NP,Node1,Node2
 Real(8),Dimension(1:3,1:3)::NodeMetric
 Real(8)::h,Norm
 Real(8),Dimension(1:Dim)::X,Y,Z
 Real(8),Dimension(1,3)::UnitV
 Real(8),Dimension(3,1)::UnitVt
 Integer,Dimension(1:2)::MDim1,MDim2
 Real(8),Dimension(1)::TempMatrix1,TempMatrix4
 Real(8),Dimension(1:3,1)::TempMatrix2
 Real(8),Dimension(1:3,1:10)::PVector
!*********************************************************************************************
!Part 1:
 PVector(1,1)  = X(Node2)-X(Node1)
 PVector(2,1)  = Y(Node2)-Y(Node1)
 PVector(3,1)  = Z(Node2)-Z(Node1)
 Call CalcVectorNormInMetric3D(NodeMetric(:,:),PVector(:,1),Norm)
...
!Part 2:
 ...
 UnitV(1,3)  = (Z(Node2)-Z(Node1))/Norm
 UnitVt(1,1) = UnitV(1,1)
 UnitVt(2,1) = UnitV(1,2)
 UnitVt(3,1) = UnitV(1,3)
