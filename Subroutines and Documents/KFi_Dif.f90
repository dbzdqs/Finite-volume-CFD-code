...
!////////////////////////////////////////////////////////////////////////////////////////////!
!*********************************************************************************************
 Subroutine KFi_Dif(Dim,NC,NFW1,NFW2,NF,NF1,NF2,IDS,NX,NY,DKX_F,DKY_F,DFiX_F,DFiY_F,Sigk,SigFi,&
                        MR,Mu,Mut,Dift)
 Implicit None
!*********************************************************************************************
 Intent(In   )::Dim,NC,NFW1,NFW2,NF,NF1,NF2,IDS,NX,NY,DKX_F,DKY_F,DFiX_F,DFiY_F,Sigk,SigFi,MR,Mu,Mut
 Intent(Out  )::Dift

 Integer::Dim,I,NC,NFW1,NFW2,NF,NF1,NF2,ME,NE
 Real(8)::Mu_k,Mu_w,Sigk,SigFi,MR,F1,F2
 Real(8),Dimension(1:Dim)::Mu,Mut,NX,NY,DKX_F,DKY_F,DFiX_F,DFiY_F
...
!Part 2:
 Do I=NF1+1,NF2
   ...
   !Part 4:
	...
	F2 = Mu_w * ( DFiX_F(I) *NX(I) + DFiY_F(I) *NY(I) ) 
...
!Part 6:
 Do I=NFW1+1,NFW2
   ...
   !Part 8:    
	...
	F2 = Mu(ME) * ( DFiX_F(I) *NX(I) + DFiY_F(I) *NY(I) ) 
