...
!////////////////////////////////////////////////////////////////////////////////////////////!
!*********************************************************************************************
 Subroutine DisJameson_3D(Dim,NC,NF1,NF2,IDS,NX,NY,NZ,DA,GM,K2,K4,WNP1,P,Dis)
 Implicit None
!*********************************************************************************************
 Intent(In   )::Dim,NC,NF1,NF2,IDS,NX,NY,NZ,DA,GM,K2,K4,WNP1,P
 Intent(Out  )::Dis

 Integer::Dim,I,NC,NF1,NF2,ME,NE
 Real(8)::C2,GM,U,V,W,Ai,E2,E4,T1,T2,T3,T4,T5,S1,S2,S3,S4,S5,F1,F2,F3,F4,F5,DW1,DW2,DW3,DW4,DW5,K2,K4
...
!Part 7:
 DO I=NF1+1,NF2
   ...
   !Part 11:
    Ai = ABS(U*NX(I)+V*NY(I)+W*NZ(I)) + SQRT(C2*DA(I)*DA(I))
