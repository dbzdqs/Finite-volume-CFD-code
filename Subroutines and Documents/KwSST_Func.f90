...
!////////////////////////////////////////////////////////////////////////////////////////////!
!*********************************************************************************************
 Subroutine KwSST_Func(Dim,NC,DW,WNP1,WTNP1,Mu,MR,DKX_C,DKY_C,DOmegX_C,DOmegY_C,Sigk1,Sigk2,&
                       Sigw1,Sigw2,Beta1,Beta2,Gama1,Gama2,Bstar,F11,F22,Sigk,Sigw,Beta,Gama)
 Implicit None
!*********************************************************************************************
 Intent(In   )::Dim,NC,DW,WNP1,WTNP1,Mu,MR,DKX_C,DKY_C,DOmegX_C,DOmegY_C,Sigk1,Sigk2,Sigw1,&
 ...
 Real(8),Dimension(1:Dim)::DW,Mu,DKX_C,DKY_C,DOmegX_C,DOmegY_C,F11,F22,Sigk,Sigw,Beta,Gama
!*********************************************************************************************
...
!Part 1:
 Do I=1,NC
   ...
   !Part 3:    
    CDkw = max( 2.0*Rho*Sigw2*(DKX_C(I)*DomegX_C(I)+DKY_C(I)*DomegY_C(I))/Omega,1.0D-20)
