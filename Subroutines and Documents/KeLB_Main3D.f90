...
!////////////////////////////////////////////////////////////////////////////////////////////!
!*********************************************************************************************
 Subroutine KeLB_Main3D(Dim,X,Y,Z,NX,NY,NZ,NC,NF,NF1,NF2,NFW1,NFW2,NFI1,NFI2,NFO1,NFO2,NFS1,NFS2,&
...
!*********************************************************************************************
 Intent(In   )::Dim,X,Y,Z,NX,NY,NZ,NC,NF,NF1,NF2,NFW1,NFW2,NFI1,NFI2,NFO1,NFO2,NFS1,NFS2,&
                NFF1,NFF2,NP,IDS,FaceType,INW,XC,YC,ZC,DW,DT,Vol,MR,NRKS,RKJ,Wb,WNP1,Mu,P,GM,DUY
 Intent(Out  )::WTNP1,Mut

 Integer::Dim,I,II,J,NS,ME
 Real(8)::RKco,K,Epsilon,Rho,Co,tauwall,ustar,yplus,Yn,fmu
