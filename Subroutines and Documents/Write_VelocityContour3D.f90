...
!////////////////////////////////////////////////////////////////////////////////////////////!
!*********************************************************************************************
 Subroutine Write_VelocityContour3D(Dim,NC,NP,X,Y,Z,Corn,WNP1)
 Implicit None
!**********************************************************************************************
 Intent(In)::Dim,NC,NP,X,Y,Z,Corn,WNP1
...
!Part 4:
 Do J=1,NC
	Write(104,*) WNP1(2,J)/WNP1(1,J)
 End Do
 Do J=1,NC
	Write(104,*) WNP1(3,J)/WNP1(1,J)
 End Do
 Do J=1,NC
	Write(104,*) WNP1(4,J)/WNP1(1,J)
 End Do
