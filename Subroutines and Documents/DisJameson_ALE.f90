...
!////////////////////////////////////////////////////////////////////////////////////////////!
!*********************************************************************************************
 Subroutine DisJameson_ALE(Dim,NC,NF1,NF2,IDS,NX,NY,DA,GM,K2,K4,WNP1,P,GF,Dis)
 Implicit None
!*********************************************************************************************
 Intent(In   )::Dim,NC,NF1,NF2,IDS,NX,NY,DA,GM,K2,K4,WNP1,P ,GF
 Intent(Out  )::Dis
...
!Part 7:
 DO I=NF1+1,NF2
   ...
   !Part 11:
   !Ai = ABS(U*NX(I)+V*NX(I)-GF(I)) + SQRT(C2*DA(I)*DA(I))  !?????
    Ai = ABS(U*NX(I)+V*NY(I)-GF(I)) + SQRT(C2*DA(I)*DA(I))  !?????
