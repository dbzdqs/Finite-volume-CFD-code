...
!//////////////////////////////////////////////////////////////////////////////////////////!
!*******************************************************************************************
 Subroutine DifMeanFlow_TurbWithkwf(Dim,NC,NFW1,NFW2,NF,NF1,NF2,IDS,GM,PrL,PrT,NX,NY,MR,Mu,Mut,&
...
!*******************************************************************************************
 ...
 Real(8)::U,V,NXX,NYY,F1,F2,F3,F4,PrL,PrT,QX,QY,K,GM,Mum,Txx,Tyy,Txy,MumL,MumT,MR,Uii,Rhom,Km,eps,Mueff
...
!Part 12:
 DO I=NFW1+1,NFW2
   ...
   !Part 16:
    ...
    Txx = -Mueff * ( 2*DUX(I)-Uii    ) 
	Txy = -Mueff * (   DVX(I)+DUY(I) )
    Tyy = -Mueff * ( 2*DVY(I)-Uii    ) 
