...
!
!  FUNCTIONS:
!  Interpolation - Entry point of console application.
!
...
!===============================
 Integer::I,J,K,NC,NP,NF,NF1,NF2,NFW1,NFW2,NFF1,NFF2,NFI1,NFI2,NFS1,NFS2,NFO1,NFO2,NFIF1,NFIF2,&
