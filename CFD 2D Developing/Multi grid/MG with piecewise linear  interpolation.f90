...
NOL=1
FTC=1
Call Interpolation2(Dim,WNP1,RES,Error,NOL,FTC)
...
!//////////////////////////////////////////////////////////////////////////////////////////!
!*******************************************************************************************
Subroutine Interpolation2(Dim,WNP1,RES,Error,NOL,FTC)
implicit none
!***********************************************************************************************************
Intent (IN)::Dim,NOL
...
!===============================
 ...
 Real(8),Dimension(1:4,1:Dim)::WNP1,WC,Con,RES,Error,delta_s0,delta_s1,delta_s2,delta_sm,delta_sn,delta_sp,FUNC1,FUNC2,FUNC3,PFUNC1,PFUNC2,PFUNC3,NFUNC1,FUNCP_2,NFUNC3,FUNCPE_2,NFUNC2,FUNCPR_2
...
!************************************************************************************************************
 ...
 Do I=1,Dim
    ...
    NFUNC1(1,I)=0;NFUNC1(2,I)=0;NFUNC1(3,I)=0;NFUNC1(4,I)=0
    FUNC1(1,I)=0;FUNC1(2,I)=0;FUNC1(3,I)=0;FUNC1(4,I)=0
    
    NFUNC2(1,I)=0;NFUNC2(2,I)=0;NFUNC2(3,I)=0;NFUNC2(4,I)=0
    FUNC2(1,I)=0;FUNC2(2,I)=0;FUNC2(3,I)=0;FUNC2(4,I)=0
    
    NFUNC3(1,I)=0;NFUNC3(2,I)=0;NFUNC3(3,I)=0;NFUNC3(4,I)=0
...
End Do
 ...
 Do I=1,NC1
        ...
        NFUNC1(1,P1)=NFUNC1(1,P1)+A(I)*FUNC1(1,I)
        NFUNC1(2,P1)=NFUNC1(2,P1)+A(I)*FUNC1(2,I)
        NFUNC1(3,P1)=NFUNC1(3,P1)+A(I)*FUNC1(3,I)
        NFUNC1(4,P1)=NFUNC1(4,P1)+A(I)*FUNC1(4,I)
        
        NFUNC2(1,P1)=NFUNC2(1,P1)+A(I)*FUNC2(1,I)
        NFUNC2(2,P1)=NFUNC2(2,P1)+A(I)*FUNC2(2,I)
        NFUNC2(3,P1)=NFUNC2(3,P1)+A(I)*FUNC2(3,I)
        NFUNC2(4,P1)=NFUNC2(4,P1)+A(I)*FUNC2(4,I)
        
        NFUNC3(1,P1)=NFUNC3(1,P1)+A(I)*FUNC3(1,I)
        NFUNC3(2,P1)=NFUNC3(2,P1)+A(I)*FUNC3(2,I)
        NFUNC3(3,P1)=NFUNC3(3,P1)+A(I)*FUNC3(3,I)
        NFUNC3(4,P1)=NFUNC3(4,P1)+A(I)*FUNC3(4,I)
                

        NFUNC1(1,P2)=NFUNC1(1,P2)+A(I)*FUNC1(1,I)
        NFUNC1(2,P2)=NFUNC1(2,P2)+A(I)*FUNC1(2,I)
        NFUNC1(3,P2)=NFUNC1(3,P2)+A(I)*FUNC1(3,I)
        NFUNC1(4,P2)=NFUNC1(4,P2)+A(I)*FUNC1(4,I)
        
        NFUNC2(1,P2)=NFUNC2(1,P2)+A(I)*FUNC2(1,I)
        NFUNC2(2,P2)=NFUNC2(2,P2)+A(I)*FUNC2(2,I)
        NFUNC2(3,P2)=NFUNC2(3,P2)+A(I)*FUNC2(3,I)
        NFUNC2(4,P2)=NFUNC2(4,P2)+A(I)*FUNC2(4,I)
        
        NFUNC3(1,P2)=NFUNC3(1,P2)+A(I)*FUNC3(1,I)
        NFUNC3(2,P2)=NFUNC3(2,P2)+A(I)*FUNC3(2,I)
        NFUNC3(3,P2)=NFUNC3(3,P2)+A(I)*FUNC3(3,I)
        NFUNC3(4,P2)=NFUNC3(4,P2)+A(I)*FUNC3(4,I)
        
        NFUNC1(1,P3)=NFUNC1(1,P3)+A(I)*FUNC1(1,I)
        NFUNC1(2,P3)=NFUNC1(2,P3)+A(I)*FUNC1(2,I)
        NFUNC1(3,P3)=NFUNC1(3,P3)+A(I)*FUNC1(3,I)
        NFUNC1(4,P3)=NFUNC1(4,P3)+A(I)*FUNC1(4,I)
        
        NFUNC2(1,P3)=NFUNC2(1,P3)+A(I)*FUNC2(1,I)
        NFUNC2(2,P3)=NFUNC2(2,P3)+A(I)*FUNC2(2,I)
        NFUNC2(3,P3)=NFUNC2(3,P3)+A(I)*FUNC2(3,I)
        NFUNC2(4,P3)=NFUNC2(4,P3)+A(I)*FUNC2(4,I)
        
        NFUNC3(1,P3)=NFUNC3(1,P3)+A(I)*FUNC3(1,I)
        NFUNC3(2,P3)=NFUNC3(2,P3)+A(I)*FUNC3(2,I)
        NFUNC3(3,P3)=NFUNC3(3,P3)+A(I)*FUNC3(3,I)
        NFUNC3(4,P3)=NFUNC3(4,P3)+A(I)*FUNC3(4,I)
 ...
 Do I=1,NP1
        NFUNC1(1,I)=NFUNC1(1,I)/A_t(I)
        NFUNC1(2,I)=NFUNC1(2,I)/A_t(I)
        NFUNC1(3,I)=NFUNC1(3,I)/A_t(I)
        NFUNC1(4,I)=NFUNC1(4,I)/A_t(I)
        
        NFUNC2(1,I)=NFUNC2(1,I)/A_t(I)
        NFUNC2(2,I)=NFUNC2(2,I)/A_t(I)
        NFUNC2(3,I)=NFUNC2(3,I)/A_t(I)
        NFUNC2(4,I)=NFUNC2(4,I)/A_t(I)
        
        NFUNC3(1,I)=NFUNC3(1,I)/A_t(I)
        NFUNC3(2,I)=NFUNC3(2,I)/A_t(I)
        NFUNC3(3,I)=NFUNC3(3,I)/A_t(I)
        NFUNC3(4,I)=NFUNC3(4,I)/A_t(I)
 End Do
...
Do I=1,NC2
    ...
    F1 = (X1(P1)-Xc2(I))*(Y1(P2)-Yc2(I))-(X1(P2)-Xc2(I))*(Y1(P1)-Yc2(I))
    F2 = (X1(P2)-Xc2(I))*(Y1(P3)-Yc2(I))-(X1(P3)-Xc2(I))*(Y1(P2)-Yc2(I))
    F3 = (X1(P3)-Xc2(I))*(Y1(P1)-Yc2(I))-(X1(P1)-Xc2(I))*(Y1(P3)-Yc2(I))
      ...
      IF(F1>=0 .AND. F2>=0 .AND. F3>=0)Then
          ...
          a23=0.5*((Xc2(I)*Y1(P2)-X1(P2)*Yc2(I))+(X1(P2)*Y1(P3)-X1(P3)*Y1(P2))+(X1(P3)*Yc2(I)-Xc2(I)*Y1(P3)))
          a13=0.5*((Xc2(I)*Y1(P3)-X1(P3)*Yc2(I))+(X1(P3)*Y1(P1)-X1(P1)*Y1(P3))+(X1(P1)*Yc2(I)-Xc2(I)*Y1(P1)))
          a12=0.5*((Xc2(I)*Y1(P1)-X1(P1)*Yc2(I))+(X1(P1)*Y1(P2)-X1(P2)*Y1(P1))+(X1(P2)*Yc2(I)-Xc2(I)*Y1(P2)))
          
          FUNC1(1,I)=(a23*NFUNC1(1,P1)+a13*NFUNC1(1,P2)+a12*NFUNC1(1,P3))/A1(J)
          FUNC1(2,I)=(a23*NFUNC1(2,P1)+a13*NFUNC1(2,P2)+a12*NFUNC1(2,P3))/A1(J)
          FUNC1(3,I)=(a23*NFUNC1(3,P1)+a13*NFUNC1(3,P2)+a12*NFUNC1(3,P3))/A1(J)
          FUNC1(4,I)=(a23*NFUNC1(4,P1)+a13*NFUNC1(4,P2)+a12*NFUNC1(4,P3))/A1(J)
          
          FUNC2(1,I)=(a23*NFUNC2(1,P1)+a13*NFUNC2(1,P2)+a12*NFUNC2(1,P3))/A1(J)
          FUNC2(2,I)=(a23*NFUNC2(2,P1)+a13*NFUNC2(2,P2)+a12*NFUNC2(2,P3))/A1(J)
          FUNC2(3,I)=(a23*NFUNC2(3,P1)+a13*NFUNC2(3,P2)+a12*NFUNC2(3,P3))/A1(J)
          FUNC2(4,I)=(a23*NFUNC2(4,P1)+a13*NFUNC2(4,P2)+a12*NFUNC2(4,P3))/A1(J)    
          
          FUNC3(1,I)=(a23*NFUNC3(1,P1)+a13*NFUNC3(1,P2)+a12*NFUNC3(1,P3))/A1(J)
          FUNC3(2,I)=(a23*NFUNC3(2,P1)+a13*NFUNC3(2,P2)+a12*NFUNC3(2,P3))/A1(J)
          FUNC3(3,I)=(a23*NFUNC3(3,P1)+a13*NFUNC3(3,P2)+a12*NFUNC3(3,P3))/A1(J)
          FUNC3(4,I)=(a23*NFUNC3(4,P1)+a13*NFUNC3(4,P2)+a12*NFUNC3(4,P3))/A1(J)    
