...
!Part 1:
 DO I=NFI1+1,NFI2
    ...
    Vn= dsqrt(U*U+V*V)
 	...
 	WTB(1,I) = Cbc*WB(1,I)*(Vn)**2d0
    WTB(2,I) = WB(1,I)*Cmu*(WTB(1,I)/WB(1,I))**1.5d0/l0
...
!Part 3:
 DO I=NFW1+1,NFW2
 	WTB(1,I) = MR * WB(2,I)*(2.0*WTNP1(2,ME)*Mu(ME)/ (WNP1(1,ME)*DW(ME)*DW(ME)) ) 
    WTB(2,I) = WTNP1(2,ME)
