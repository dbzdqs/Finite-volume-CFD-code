...
!*******************************************************************************************
 Intent(In   )::Dim,X,Y,NX,NY,NC,NF,NF1,NF2,NFW1,NFW2,NFI1,NFI2,NFO1,NFO2,NFS1,NFS2,NFF1,&
                NFF2,NP,IDS,INW,XC,YC,DW,DT,A,MR,NRKS,Wb,WNP1,Mu,DUY,RKJ,p
 Intent(Out  )::WTNP1,Mut
 Intent(inOut  ):: IWF
 

 Integer::Dim,I,II,J,NC,NS,NP,NRKS,ME,NF,NFW1,NFW2,NF1,NF2,NFI1,NFI2,NFO1,NFO2,NFS1,NFS2,NFF1,NFF2
 Real(8)::RKco,K,Epsilon,Rho,MR,Co,tauwall,ustar,yplus,Yn,fmu,Sigk,Sige,Ce1,Ce2,Cmu, rm
...
!Part 3:
 Do NS=1,NRKS
   ...
   !Part 5:
    Call Ke_BC(Dim,NX,NY,NF,NFS1,NFS2,NFO1,NFO2,NFW1,NFW2,NFI1,NFI2,NFF1,NFF2,WB,WTNP1,IDS,WTB,MR,DW,wnp1,mu)
