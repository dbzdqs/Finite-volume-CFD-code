...
!//////////////////////////////////////////////////////////////////////////////////////////!
!**********************************************************************************************
 Subroutine Transition_SST_VYuntao(Dim,Ncyc,INW,X,Y,NX,NY,NC,NF,NF1,NF2,NFW1,NFW2,NFI1,NFI2,NFO1,NFO2,NFS1,NFS2,NFF1,NFF2,NP,IDS,XC,YC,DW,DT,A,Minf,Rinf,MR,R0,&
...
!********************************************************************************************** 
 ...
 Real(8)::ALF,Minf,Mu0,U,V,RKco,Rinf,K,Omega,R0,MR,TUinf,Mutinf
 ...
 Real(8),Dimension(1:Dim)::DDUX,DDUY,DDVX,DDVY,DDKX,DDKY,DDOmegX,DDOmegY,DDGX,DDGY,DDRX,DDRY,CDKw,F11,F22,sigmak,sigmaw,beta,gama,Vor,Error
...
!**********************************************************************************************
    ...
    !Part 2:
    Call TraSST_BC_V1(Dim,NX,NY,NF,NFS1,NFS2,NFO1,NFO2,NFW1,NFW2,NFI1,NFI2,NFF1,NFF2,DW,Wb,Wbt,Wnp1,Wntp1,IDS,Minf,Rinf,MR,Mu,TUinf,Mutinf)
 ...
 !Part 3:
    ...
    End Do
      ...
      !Part 6:
       ...
       Call KwSST_GradCell(A,Dim,NC,NFW1,NFW2,NF,NF1,NF2,IDS,NX,NY,DW,MR,Wnp1,Wntp1,Wb,Wbt,DDUX,DDUY,DDVX,DDVY,DDKX,DDKY,DDOmegX,DDOmegY,&
                            Mu,Mut)
    
      !Part 7:
       Call TraSST_GradFace(Dim,NC,NFW1,NFW2,NF,NF1,NF2,NP,IDS,X,Y,XC,YC,DGX,DGY,DRX,DRY,DW,MR,beta1,Wnp1,Wntp1,Wb,Wbt,Mu,Mut)
       Call KwSST_GradFace(Dim,NC,NFW1,NFW2,NF,NF1,NF2,NP,IDS,X,Y,XC,YC,DKX,DKY,DOmegX,DOmegY,DW,MR,beta1,Wnp1,Wntp1,Wb,Wbt,Mu,Mut)
       
       !part 8:
       Call KwSST_Funcs(A,Dim,NC,IDS,NX,NY,DW,MR,Wnp1,Wntp1,DDUX,DDUY,DDVX,DDVY,DDKX,DDKY,DDOmegX,DDOmegY,&
                 sigmak1,sigmak2,sigmaw1,sigmaw2,beta1,beta2,gama1,gama2,betastar,F11,F22,Sigmak,Sigmaw,beta,gama,Mu,Mut)
                  
       
       Call TraSST_Funcs_VYuntao(A,Dim,NC,IDS,NX,NY,DW,MR,Wnp1,Wntp1,DDUX,DDUY,DDVX,DDVY,DDKX,DDKY,DDOmegX,DDOmegY,&
                  sigmak1,sigmak2,sigmaw1,sigmaw2,beta1,beta2,gama1,gama2,betastar,F11,F22,Sigmak,Sigmaw,beta,gama,Mu,Mut,&
      ...
      !Part 10:
	   Call KwSST_Dif(Dim,NC,NFW1,NFW2,NF,NF1,NF2,IDS,NX,NY,DKX,DKY,DOmegX,DOmegY,MR,Wnp1,Wntp1,Wb,Wbt,Mu,Mut,Sigmak,Sigmaw,beta1,Dift)
       Call TraSST_Dif(Dim,NC,NFW1,NFW2,NF,NF1,NF2,IDS,NX,NY,DGX,DGY,DRX,DRY,MR,Wnp1,Wntp1,Wb,Wbt,Mu,Mut,Dift)
	               
      !Part 11:
       Call TraSST_Source(A,Dim,IDS,NC,MR,Wnp1,Wntp1,Mu,Mut,DDUX,DDUY,DDVX,DDVY,DDKX,DDKY,DDOmegX,DDOmegY,&
