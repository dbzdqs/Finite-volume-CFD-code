...
!//////////////////////////////////////////////////////////////////////////////////////////!
!*******************************************************************************************
Subroutine TraSST_BC_V2(Dim,NX,NY,NF,NFS1,NFS2,NFO1,NFO2,NFW1,NFW2,NFI1,NFI2,NFF1,NFF2,DW,Wb,Wbt,Wnp1,Wntp1,IDS,Minf,Rinf,MR,Mu,Mutinf,TUinf)
 Implicit None
!**********************************************************************************************
...
!**********************************************************************************************	
 ...
 ! Mutinf = 8.0
  ...
  DO I=NFI1+1,NFI2
    ...
    Wbt(2,I) = Oinf 
    Wbt(3,I) = 1.0
    Wbt(4,I) = 803.73*(TUinf+0.6067)**(-1.027)
