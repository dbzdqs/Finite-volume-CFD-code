...
!*******************************************************************************************
!**********************************************************************************************
 Subroutine TraSST_Source(A,Dim,IDS,NC,MR,Wnp1,Wntp1,Mu,Mut,DDUX,DDUY,DDVX,DDVY,DDKX,DDKY,DDOmegX,DDOmegY,&
...
!**********************************************************************************************
 ...
 Real(8),Dimension(1:4,1:Dim)::Wntp1,Sout
...
!***************************************************************************************************  
 ...
 Do I=1,NC
    ...
    Sout(4,I) = -ctt*(Rho/T(I))*(Reteq(I)-Rett)*(1.0-Ftt(I))
