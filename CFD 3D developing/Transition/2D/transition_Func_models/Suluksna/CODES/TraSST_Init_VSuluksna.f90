...
!//////////////////////////////////////////////////////////////////////////////////////////!
!*******************************************************************************************
 Subroutine TraSST_Init_VSuluksna(Dim,NC,NFW1,NFW2,IDS,X,Y,Xc,Yc,Dw,INW,R0,Minf,Rinf,Wnt,Wntp1,Mut,Mutinf,TUinf,Init,WNP1) 
 Implicit None
!*******************************************************************************************
...
!Part 1:
 ...
 Do J=1,NC
    ...
    Wntp1(2,J)=Oinf
    Wntp1(3,J)=1.0
    Wntp1(4,I) = 803.73*(TUinf+0.6067)**(-1.027)
