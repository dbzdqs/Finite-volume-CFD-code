...
!// Boundary Condition for transition model                                              //!
...
!//////////////////////////////////////////////////////////////////////////////////////////!
!*******************************************************************************************
Subroutine Gamma_TraSST_BC(Dim,NX,NY,NF,NFS1,NFS2,NFO1,NFO2,NFW1,NFW2,NFI1,NFI2,NFF1,NFF2,&
                           DW,Wb,Wbt,Wnp1,Wntp1,IDS,Minf,Rinf,MR,Mu,TUinf,Mutinf)
 Implicit None
!**********************************************************************************************
 ...
 Real(8),Dimension(1:3,1:Dim)::Wbt,Wntp1
