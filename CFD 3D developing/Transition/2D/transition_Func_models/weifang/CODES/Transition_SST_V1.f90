...
!*******************************************************************************************!
!**********************************************************************************************
 Subroutine Transition_SST_V1(Dim,Ncyc,INW,X,Y,NX,NY,NC,NF,NF1,NF2,NFW1,NFW2,NFI1,NFI2,NFO1,NFO2,NFS1,NFS2,NFF1,NFF2,NP,IDS,XC,YC,DW,DT,A,Minf,Rinf,MR,R0,&
 ...
 !Part 3:
    ...
    End Do
      ...
      !Part 7:
       ...
       Call TraSST_Funcs_VWeifang(A,Dim,NC,IDS,NX,NY,DW,MR,Wnp1,Wntp1,DDUX,DDUY,DDVX,DDVY,DDKX,DDKY,DDOmegX,DDOmegY,&
                  sigmak1,sigmak2,sigmaw1,sigmaw2,beta1,beta2,gama1,gama2,betastar,F11,F22,Sigmak,Sigmaw,beta,gama,Mu,Mut,&
