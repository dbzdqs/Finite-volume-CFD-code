...
!//////////////////////////////////////////////////////////////////////////////////////////!
!*******************************************************************************************!
 Subroutine Weifang_Transition_SST(Dim,Ncyc,INW,X,Y,NX,NY,NC,NF,NF1,NF2,NFW1,NFW2,NFI1,NFI2,NFO1,NFO2,NFS1,NFS2,NFF1,NFF2,NP,IDS,XC,YC,DW,DT,A,Minf,Rinf,MR,R0,&
            NRKS,Mu0,Wb,Wbt,Wnp1,Wnt,Wntp1,Mu,Mut, NN,TUinf,Mutinf)
 Implicit None
!********************************************************************************************** 
 Integer::Dim,I,J,Ii,Jj,NC,NF,NFW1,NFW2,NF1,NF2,NS,Ncyc,NP,NRKS,ME,NFI1,NFI2,NFO1,NFO2,NFS1,NFS2,NFF1,NFF2  ,NN
 ...
 Real(8),Dimension(1:Dim)::DDUX,DDUY,DDVX,DDVY,DDKX,DDKY,DDOmegX,DDOmegY,DDGX,DDGY,DDRX,DDRY,CDKw,F11,F22,sigmak,sigmaw,beta,gama,Vor,Error,Rev
...
!**********************************************************************************************
    ...
    !Part 2:
    Call Gamma_TraSST_BC(Dim,NX,NY,NF,NFS1,NFS2,NFO1,NFO2,NFW1,NFW2,NFI1,NFI2,NFF1,NFF2,DW,Wb,Wbt,Wnp1,Wntp1,IDS,Minf,Rinf,MR,Mu,TUinf,Mutinf)
...
!NRKS=4
      ...
      !Part 6:
       ...
       Call Gamma_KwSST_GradCell(A,Dim,NC,NFW1,NFW2,NF,NF1,NF2,IDS,NX,NY,DW,MR,Wnp1,Wntp1,Wb,Wbt,DDUX,DDUY,DDVX,DDVY,DDKX,DDKY,DDOmegX,DDOmegY,&
                         Mu,Mut)
    
      !Part 7:
       Call Gamma_TraSST_GradFace(Dim,NC,NFW1,NFW2,NF,NF1,NF2,NP,IDS,X,Y,XC,YC,DGX,DGY,DW,MR,beta1,Wnp1,Wntp1,Wb,Wbt,Mu,Mut)
       Call Gamma_KwSST_GradFace(Dim,NC,NFW1,NFW2,NF,NF1,NF2,NP,IDS,X,Y,XC,YC,DKX,DKY,DOmegX,DOmegY,DW,MR,beta1,Wnp1,Wntp1,Wb,Wbt,Mu,Mut)
       
       !part 8:
       Call Gamma_KwSST_Funcs(A,Dim,NC,IDS,NX,NY,DW,MR,Wnp1,Wntp1,DDUX,DDUY,DDVX,DDVY,DDKX,DDKY,DDOmegX,DDOmegY,&
               sigmak1,sigmak2,sigmaw1,sigmaw2,beta1,beta2,gama1,gama2,betastar,F11,F22,Sigmak,Sigmaw,beta,gama,Mu,Mut)
                  
       
       Call Weifang_TraSST_Funcs(A,Dim,NC,IDS,NX,NY,DW,MR,Wnp1,Wntp1,DDUX,DDUY,DDVX,DDVY,DDKX,DDKY,DDOmegX,DDOmegY,&
                  sigmak1,sigmak2,sigmaw1,sigmaw2,beta1,beta2,gama1,gama2,betastar,F11,F22,Sigmak,Sigmaw,beta,gama,Mu,Mut,&
      ...
      !Part 10:
	   Call Gamma_KwSST_Dif(Dim,NC,NFW1,NFW2,NF,NF1,NF2,IDS,NX,NY,DKX,DKY,DOmegX,DOmegY,MR,Wnp1,Wntp1,Wb,Wbt,Mu,Mut,Sigmak,Sigmaw,beta1,Dift)
       Call Gamma_TraSST_Dif(Dim,NC,NFW1,NFW2,NF,NF1,NF2,IDS,NX,NY,DGX,DGY,MR,Wnp1,Wntp1,Wb,Wbt,Mu,Mut,Dift)
	               
      !Part 11:
      Call Weifang_TraSST_Source(A,Dim,IDS,NC,MR,Wnp1,Wntp1,Mu,Mut,DDUX,DDUY,DDVX,DDVY,DDKX,DDKY,DDOmegX,DDOmegY,&
                        betastar,sigmaw2,beta,gama,F11,Flength,Strain,Fonset,Fturb,T,Reteq,Ftt,Geff,Sout)
      
    !  Call Gamma_TraSST_Source1(A,Dim,IDS,NC,MR,Wnp1,Wntp1,Mu,Mut,DDUX,DDUY,DDVX,DDVY,DDKX,DDKY,DDOmegX,DDOmegY,&
     !                    betastar,sigmaw2,beta,gama,F11,Strain,Fonset,Fturb,T,Reteq,Ftt,Geff,Rev,Sout)
      ...
      !Part 15:
        ...
        ! Vor(I) =  Dsqrt ( 0.5*(DDUY(I)-DDVX(I))*(DDUY(I)-DDVX(I)) )
        ! Strain(I) =Dsqrt ( 0.5*(DDUY(I)+DDVX(I))*(DDUY(I)+DDVX(I)) )
      !Part 16:     
