...
!//////////////////////////////////////////////////////////////////////////////////////////!
!// Description:Consist of coefficient matrix for Radfial basis function(moving mesh)    //!
!//                                                                                      //!
!// Version: V1                                                                          //!
!// Date: May, 23, 2017                                                                  //!
!// Developed by: M. Namvar, M. Valadkhani, Iran, Tehran, OpenFlows@chmail.ir            //!
!// Doc ID:                                                                              //!
!//                                                                                      //!
...
!//////////////////////////////////////////////////////////////////////////////////////////!
!*******************************************************************************************
 Subroutine Defin_BoundPoint_Displac_3D(Dim,NFW1,NFW2,FaceType,IDS,X,Y,Z,Time,dT,Test_Case,Minf,alfa,Omega,Delx,Dely,Delz)
 Implicit None
!******************************************************************************************* 
 Intent(In ):: Dim,NFW1,NFW2,FaceType,IDS,X,Y,Z,Time,dT,Test_Case,Minf
 Intent(Out )::omega,Delx,Dely,Delz
 Intent(InOut )::alfa
 
 Integer::Dim,I,J,NFW1,NFW2,P1,Test_Case
 Real(8)::PI,Amplitude,omega,Time,dT,k,Xo,Yo,X_Vec,Y_Vec,X_Rot,Y_Rot,&
          Minf,alfa,Del_Teta,TetaMax,Alpha_Dot,DeltaY,Face_Type
 Real(8),Dimension(1:Dim)::Delx,Dely,Delz,X,Y,Z
