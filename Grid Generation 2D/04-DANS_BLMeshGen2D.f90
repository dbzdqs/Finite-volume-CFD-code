...
!//----------------------------------------------------------------------------------------------------//!
!// Description:                                                                                       //!
!// The main object of this code is for generation of boundary layer mesh. In most common problems of  //!
!// computational fluid dynamics boundary layer mesh is necessary to have accurate simulation          //!
!// specifically in computation boundary layer parameters. One of the successful methods for generating//!
!// boundary layer mesh is based on moving main mesh and creating empty space for replacing boundary   //!
!// layer mesh. In this method firstly, boundary layer mesh is generated and then bulk mesh is merged  //!
!// to boundary layer mesh.                                                                            //!
!////////////////////////////////////////////////////////////////////////////////////////////////////////!
!*********************************************************************************************************
 Program BLMeshGen2D
 Implicit None
...
!==============================
 ...
 Integer::NE,  !Neighboring and Main Elements 
...
!Part 5:
 CuspPt(:) = 0
 do i=1,NPtCurvs
    if(AngleBP(i)>50 .or. IConectedEdg(1,i)==0 .or. IConectedEdg(2,i)==0  )then
     CuspPt(i) = 1
...
!Part 13:
 ...
 Do I=1,NF
    ...
    NE = IDS(2,I)
    If(NE/=0) then
     If (NEdgOfCell(ME)==3 .and. NEdgOfCell(NE)==3) then
      NStack = NStack + 1
      Stack(NStack) = I
     End If
    End if
